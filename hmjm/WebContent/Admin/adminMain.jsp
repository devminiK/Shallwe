...
<input type="button" value="Message" onClick="window.open('/hmjm/Message/msg.jsp','_blank','toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable=no,directories=no,width=620,height=600')"/>
