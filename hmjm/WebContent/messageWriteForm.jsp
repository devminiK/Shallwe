...
<table width="800" border="1" cellspacing="0" cellpadding="0" align="center">
	<tr><td width="100" align="center">보내는사람</td>
    	<td width="330"><input type="text" size="10" maxlength="10" name="s_send" value="<%=id %>" readonly>
    	<td width="100" align="center">받는사람</td>
    	<td width="330"><input type="text" size="10" maxlength="10" name="s_receive"></td>
	</tr>
  
	<tr><td width="70" align="center" >내 용</td>
	  	<td width="330" ><textarea name="s_content" rows="5" cols="50"></textarea></td>
	</tr>
</table>
